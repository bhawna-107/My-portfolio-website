const styles = {
    ...
    heroSubText:
      "text-[black] font-medium lg:text-[20px] sm:text-[18px] xs:text-[14px] text-[12px] lg:leading-[40px]",
  
    sectionHeadText:
      "text-[#4477CE] font-[#4477CE] md:text-[50px] sm:text-[40px] xs:text-[30px] text-[20px]",
    sectionSubText:
    ...
    iconsText:
      "text-[#4477CE] font-[#4477CE] md:text-[40px] sm:text-[30px] xs:text-[30px] text-[25px]",
    contactText:
    "text-[black]  md:text-[50px] sm:text-[35px] xs-text:[30px] text-[30px]",
    buttontext:
    "bg-[#4477CE] hover:text-[black] cursor-pointer"
  };
